...
# 	inv_time_range = inv_time_range.clamp(min=0.0).type(torch.int64)
# 	length_onehot_neg = one_hot(x=inv_time_range, num_classes=torch.tensor(dataset_max_len), dtype=torch.int64)
