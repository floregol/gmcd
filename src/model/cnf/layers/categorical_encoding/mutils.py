...
from src.model.cnf.layers.categorical_encoding.variational_dequantization import VariationalDequantization
from src.model.cnf.layers.categorical_encoding.linear_encoding import LinearCategoricalEncoding
from src.model.cnf.layers.categorical_encoding.variational_encoding import VariationalCategoricalEncoding
...
def create_encoding(encoding_params, dataset_class, vocab=None, vocab_size=-1, category_prior=None):
	...
	return encoding_flow(dataset_class=dataset_class,
						 ...
						 num_dimensions=encoding_params.categ_encoding_num_dimensions, flow_config=encoding_params.categ_encoding_flow_config)
