...
if __name__ == '__main__':
    ...
    if experiment == "SYNTH":
        ...
        ground_truth_p = make_stair_prob(U,
                                         posU=posU,
                                         ratio=ratio,
                                         num_s=num_s)

        list_of_samples, list_of_pmf_q = load_samples(list_of_espilon_q,
                                                      init_b, ground_truth_p,
                                                      splits, U, m_per_splits,
                                                      num_s, ratio, TYPE)
        store_results = {}
        ...
        dict_of_samples, ground_truth_p = load_generative_model_samples(
            power_base, ratio, database_type)
    ...
    perform_our_test(list_of_samples, list_of_title_q, num_s, trials,
                     ...
                     test_epsilon, delta, list_of_pmf_q)
